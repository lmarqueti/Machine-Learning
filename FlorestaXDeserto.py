...
class Interface():
    ...
    def Treinamento(self):
        ...
        self.classificador.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy'])
        ...
        base_teste = gerador_treinamento.flow_from_directory('imagensRede/Teste', target_size=(64, 64), batch_size=32,
                                                             class_mode='binary')

        self.classificador.fit_generator(base_treinamento, steps_per_epoch=20, epochs=3, validation_data=base_teste,
                                         validation_steps=20)
        self.contador = 1

    def ClassificarImagens(self):
        imagem_teste = image.image_load(self.filename, target_size=(64, 64))
